...
// - Under macOS: "OpenCV: AVF: waiting to write video data." is displayed in error output by CAP_AVFOUNDATION backend (see https://github.com/opencv/opencv/issues/19999)
